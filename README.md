...
R package **mrmagpie**, version **1.53.0.9001**
...
Karstens K, Dietrich J, Chen D, Windisch M, Alves M, Beier F, Köberle A, v. Jeetze P, Mishra A, Humpenoeder F, Sauer P (2024). _mrmagpie: madrat based MAgPIE Input Data Library_. doi:10.5281/zenodo.4319612 <https://doi.org/10.5281/zenodo.4319612>, R package version 1.53.0.9001, <https://github.com/pik-piam/mrmagpie>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 1.53.0.9001},
